...
##### Method 2
This method returns random unique pins based on the parameters supplied
...
**Parameter 1: minVal**
 >The minimum range of the number to generate. Must be non-negative and less than maxVal param
 
**Parameter 2: maxVal**
>The maximum range of the number to generate. Must be non-negative and greater than minVal Param
       
**Parameter 3: noOfPins**
>The total number of pins in the set. Must be greater than 0 and less than or equals to the difference of maxVal and minVal

**Exception**       
>*IllegalArgumentException* when any of the parameter conditions are violated

**Usage**
```$xslt
generateBatchOfUniqueRandomPins(100, 200, 50);
```
...
public class Main {
    public static void main(String[] args) {
        RandomPinGeneration randomPinGeneration = new RandomPinGenerator();
        Set<Integer> randomPins = randomPinGeneration.generateBatchOfUniqueRandomPins(100, 200, 50);
        System.out.println(randomPins);
    }
}
```
###### Output
```$xslt
[129, 130, 134, 135, 137, 138, 139, 140, 141, 142, 144, 145, 147, 148, 149, 151, 152, 153, 155, 156, 157, 160, 161, 164, 165, 168, 169, 170, 173, 176, 179, 180, 181, 184, 185, 191, 195, 196, 199, 200, 100, 102, 104, 114, 115, 117, 120, 122, 125, 127]
```